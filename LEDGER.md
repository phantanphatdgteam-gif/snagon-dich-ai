...
- [ ] Popup: đường "SW chết giữa job → hiện lỗi" CHƯA được kiểm bằng cả test tự động lẫn tay. Chrome mới bỏ nút stop service worker, và `sendMessage` tới SW đang ngủ sẽ đánh thức nó chứ không reject, nên không tái hiện thủ công được; giết extension giữa lúc dịch thì popup đóng theo. Cần tầng e2e Playwright mới kiểm được — M2
